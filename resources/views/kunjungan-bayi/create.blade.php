    ...
    <x-slot name="header">
        ...
        <nav class="breadcrumb">
            <ol class="list-reset flex text-sm">
                ...
                <li><span class="mx-2">/</span></li>
                <li class="text-gray-600">Tambah Kunjungan Bayi</li>
            </ol>
        </nav>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Form Tambah Kunjungan Bayi</h3>
                ...
                <!-- Form untuk menambahkan kunjungan bayi -->
                <form method="POST" action="{{ route('kunjungan-bayi.store') }}">
                    @csrf

                    <!-- Nama Bayi -->
                    <div class="mb-4">
                        <label for="nama_ibu" class="block text-sm font-medium text-gray-700">Nama Bayi</label>
                    ...
                    <!-- Umur Ibu -->
                    <div class="mb-4">
                        <label for="umur_ibu" class="block text-sm font-medium text-gray-700">Umur Bayi</label>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" id="tempat_lahir" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Nama lokasi tempat lahir" value="{{ old('tempat_lahir') }}">
                        </div>
                    ...
                    <!-- 2. Tanggal -->
                    <div class="mb-4">
                        <label for="tanggal_kunjungan" class="block text-sm font-medium text-gray-700">2. Tanggal Kunjungan</label>
                    ...
                    <div class="mb-4">
                        <label for="pemantauan_suhu_tubuh" class="block text-sm font-medium text-gray-700">3. Pemantauan Suhu Tubuh</label>
                        <select name="pemantauan_suhu_tubuh" id="pemantauan_suhu_tubuh" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            <option value="<37.5 C" {{ old('pemantauan_suhu_tubuh') == '<37.5 C' ? 'selected' : '' }}> <37.5 C</option>
                            <option value=">=36.5 C" {{ old('pemantauan_suhu_tubuh') == '>=36.5 C' ? 'selected' : '' }}>>=36.5 C</option>
                        </select>
                    </div>

                    <!-- 4. Ada Buku KIA -->
                    <div class="mb-4">
                        <label for="ada_buku_kia" class="block text-sm font-medium text-gray-700">4. Ada Buku KIA</label>
                        <select name="ada_buku_kia" id="ada_buku_kia" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            <option value="Ada" {{ old('ada_buku_kia') == 'Ada' ? 'selected' : '' }}>Ada</option>
                            <option value="Tidak" {{ old('ada_buku_kia') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                        </select>
                    </div>

                    <!-- 5. ASI Eksklusif -->
                    <div class="mb-4">
                        <label for="asi_eksklusif" class="block text-sm font-medium text-gray-700">5. ASI Eksklusif</label>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="tanggal_terakhir_ditimbang" id="tanggal_terakhir_ditimbang" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('tanggal_terakhir_ditimbang') }}">
                        </div>
                        <div>
                            <label for="tempat_penimbangan" class="block text-sm font-medium text-gray-700">Tempat Penimbangan</label>
                            <input type="text" name="tempat_penimbangan" id="tempat_penimbangan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('tempat_penimbangan') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" step="0.01" name="berat_badan" id="berat_badan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('berat_badan') }}">
                        </div>
                        <div>
                            <label for="panjang_badan" class="block text-sm font-medium text-gray-700">Panjang Badan (cm)</label>
                            <input type="number" step="0.01" name="panjang_badan" id="panjang_badan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('panjang_badan') }}">
                        </div>
                        <div>
                            <label for="lingkar_kepala" class="block text-sm font-medium text-gray-700">Lingkar Kepala (cm)</label>
                            <input type="number" step="0.01" name="lingkar_kepala" id="lingkar_kepala" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('lingkar_kepala') }}">
                        </div>
                    </div>
                   ...
                   <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            <label for="berat_badan" class="block text-sm font-medium text-gray-700">7. Berat Badan (Kg)</label>
                            <input type="number" step="0.01" name="berat_badan" id="berat_badan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('berat_badan') }}">
                        </div>
                        <div>
                            <label for="panjang_badan" class="block text-sm font-medium text-gray-700">Panjang Badan (cm)</label>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="pelayanan_neonatal_essensial_0_6_jam" id="pelayanan_neonatal_essensial_0_6_jam" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('pelayanan_neonatal_essensial_0_6_jam') }}">
                        </div>
                        <div>
                            <label for="tempat_pelayanan_neonatal_0_6_jam" class="block text-sm font-medium text-gray-700">Tempat Pelayanan</label>
                            <input type="text" name="tempat_pelayanan_neonatal_0_6_jam" id="tempat_pelayanan_neonatal_0_6_jam" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('tempat_pelayanan_neonatal_0_6_jam') }}">
                        </div>
                        <div>
                            <label for="petugas_pelayanan_neonatal_0_6_jam" class="block text-sm font-medium text-gray-700">Petugas Pelayanan</label>
                            <input type="text" name="petugas_pelayanan_neonatal_0_6_jam" id="petugas_pelayanan_neonatal_0_6_jam" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('petugas_pelayanan_neonatal_0_6_jam') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="kn1_6_48_jam" id="kn1_6_48_jam" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('kn1_6_48_jam') }}">
                        </div>
                        <div>
                            <label for="tempat_kn1" class="block text-sm font-medium text-gray-700">Tempat KN 1</label>
                            <input type="text" name="tempat_kn1" id="tempat_kn1" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('tempat_kn1') }}">
                        </div>
                        <div>
                            <label for="petugas_kn1" class="block text-sm font-medium text-gray-700">Petugas KN 1</label>
                            <input type="text" name="petugas_kn1" id="petugas_kn1" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('petugas_kn1') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="kn2_3_7_hari" id="kn2_3_7_hari" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('kn2_3_7_hari') }}">
                        </div>
                        <div>
                            <label for="tempat_kn2" class="block text-sm font-medium text-gray-700">Tempat KN 2</label>
                            <input type="text" name="tempat_kn2" id="tempat_kn2" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('tempat_kn2') }}">
                        </div>
                        <div>
                            <label for="petugas_kn2" class="block text-sm font-medium text-gray-700">Petugas KN 2</label>
                            <input type="text" name="petugas_kn2" id="petugas_kn2" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('petugas_kn2') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <input type="date" name="kn3_8_28_hari" id="kn3_8_28_hari" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('kn3_8_28_hari') }}">
                        </div>
                        <div>
                            <label for="tempat_kn3" class="block text-sm font-medium text-gray-700">Tempat KN 3</label>
                            <input type="text" name="tempat_kn3" id="tempat_kn3" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('tempat_kn3') }}">
                        </div>
                        <div>
                            <label for="petugas_kn3" class="block text-sm font-medium text-gray-700">Petugas KN 3</label>
                            <input type="text" name="petugas_kn3" id="petugas_kn3" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('petugas_kn3') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <select name="hepatitis_b_0_bulan" id="hepatitis_b_0_bulan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('hepatitis_b_0_bulan') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('hepatitis_b_0_bulan') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="bcg_0_bulan" id="bcg_0_bulan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('bcg_0_bulan') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('bcg_0_bulan') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="polio_tetes_1_0_bulan" id="polio_tetes_1_0_bulan" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('polio_tetes_1_0_bulan') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('polio_tetes_1_0_bulan') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <select name="napas" id="napas" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('napas') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('napas') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="aktifitas" id="aktifitas" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('aktifitas') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('aktifitas') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="warna_kulit" id="warna_kulit" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('warna_kulit') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('warna_kulit') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <select name="hisapan_bayi" id="hisapan_bayi" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('hisapan_bayi') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('hisapan_bayi') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="kejang" id="kejang" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('kejang') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('kejang') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            <label for="suhu_tubuh_tanda_bahaya" class="block text-sm font-medium text-gray-700">25. Suhu Tubuh</label>
                            <select name="suhu_tubuh_tanda_bahaya" id="suhu_tubuh" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('suhu_tubuh_tanda_bahaya') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('suhu_tubuh_tanda_bahaya') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <select name="bab" id="bab" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('bab') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('bab') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="jumlah_warna_air_kencing" id="jumlah_warna_air_kencing" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('jumlah_warna_air_kencing') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('jumlah_warna_air_kencing') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="tali_pusat" id="tali_pusat" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('tali_pusat') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('tali_pusat') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <select name="mata" id="mata" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('mata') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('mata') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="kulit_tanda_bahaya" id="kulit_tanda_bahaya" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('kulit_tanda_bahaya') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('kulit_tanda_bahaya') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="imunisasi_tanda_bahaya" id="imunisasi_tanda_bahaya" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('imunisasi_tanda_bahaya') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('imunisasi_tanda_bahaya') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <select name="mengingatkan_periksa_pustu" id="mengingatkan_periksa_pustu" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <option value="Ya" {{ old('mengingatkan_periksa_pustu') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                <option value="Tidak" {{ old('mengingatkan_periksa_pustu') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        <div>
                            <label for="melaporkan_ke_nakes" class="block text-sm font-medium text-gray-700">33. Melaporkan ke Nakes</label>
                            <input type="date" name="melaporkan_ke_nakes" id="melaporkan_ke_nakes" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('melaporkan_ke_nakes') }}">
                        </div>
                    </div>
