            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <form action="{{ route('kunjungan-ibu-bersalin.update', $kunjungan->id) }}" method="POST">
                    ...
                    <div class="flex justify-end mt-6">
                        <!-- Tombol Kembali -->
                        <a href="{{ route('kunjungan-ibu-bersalin.index') }}" class="ml-2 bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded shadow inline-block text-center">
                        Kembali
                    </a>
                        <button type="submit" class="ml-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded shadow">
                        Simpan Perubahan
                    </button>
                    </div>
                </form>
