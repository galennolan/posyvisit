    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Formulir Edit Kunjungan Lansia</h3>

                <form action="{{ route('kunjungan-lansia.update', $kunjungan->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        @if(isset($kunjungan->anggotaKeluarga))
                            ...
                            <input type="hidden" name="nama_lansia" value="{{ $kunjungan->anggotaKeluarga->nama_lengkap }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', $kunjungan->tanggal) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1">
                            <label class="inline-flex items-center">
                                <input type="radio" name="suhu_tubuh" value="<37,5°C" class="form-radio" {{ old('suhu_tubuh', $kunjungan->suhu_tubuh) == '<37,5°C' ? 'checked' : '' }}>
                    ...
                    <!-- Pemeriksaan Tekanan Darah dalam satu tahun terakhir -->
                    <div class="mb-4">
                        ...
                        <div class="space-y-2 mt-2">
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <input type="date" name="pemeriksaan_tekanan_darah_tahun_terakhir" id="pemeriksaan_tekanan_darah_tahun_terakhir" value="{{ old('pemeriksaan_tekanan_darah_tahun_terakhir', $kunjungan->pemeriksaan_tekanan_darah_tahun_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                </div>

                                <!-- Tempat Pemeriksaan -->
                                <div class="flex-1">
                                    <label for="tempat_pemeriksaan_tekanan_darah_tahun_terakhir" class="block text-sm text-gray-700">Tempat</label>
                                    <input type="text" name="tempat_pemeriksaan_tekanan_darah_tahun_terakhir" id="tempat_pemeriksaan_tekanan_darah_tahun_terakhir" value="{{ old('tempat_pemeriksaan_tekanan_darah_tahun_terakhir', $kunjungan->tempat_pemeriksaan_tekanan_darah_tahun_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Klinik Y">
                                </div>

                                <!-- Hasil Pemeriksaan -->
                                <div class="flex-1">
                                    <label for="hasil_pemeriksaan_tekanan_darah_tahun_terakhir" class="block text-sm text-gray-700">Hasil</label>
                                    <input type="text" name="hasil_pemeriksaan_tekanan_darah_tahun_terakhir" id="hasil_pemeriksaan_tekanan_darah_tahun_terakhir" value="{{ old('hasil_pemeriksaan_tekanan_darah_tahun_terakhir', $kunjungan->hasil_pemeriksaan_tekanan_darah_tahun_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: 120/80 mmHg">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="terdiagnosa_hipertensi_tahun_terakhir" id="terdiagnosa_hipertensi_tahun_terakhir" value="{{ old('terdiagnosa_hipertensi_tahun_terakhir', $kunjungan->terdiagnosa_hipertensi_tahun_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                    </div>
                        ...
                        <div class="space-y-2 mt-2">
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <input type="date" name="pemeriksaan_tekanan_darah_bulan_terakhir" id="pemeriksaan_tekanan_darah_bulan_terakhir" value="{{ old('pemeriksaan_tekanan_darah_bulan_terakhir', $kunjungan->pemeriksaan_tekanan_darah_bulan_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                </div>

                                <!-- Tempat Pemeriksaan -->
                                <div class="flex-1">
                                    <label for="tempat_pemeriksaan_tekanan_darah_bulan_terakhir" class="block text-sm text-gray-700">Tempat</label>
                                    <input type="text" name="tempat_pemeriksaan_tekanan_darah_bulan_terakhir" id="tempat_pemeriksaan_tekanan_darah_bulan_terakhir" value="{{ old('tempat_pemeriksaan_tekanan_darah_bulan_terakhir', $kunjungan->tempat_pemeriksaan_tekanan_darah_bulan_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Klinik Y">
                                </div>

                                <!-- Hasil Pemeriksaan -->
                                <div class="flex-1">
                                    <label for="hasil_pemeriksaan_tekanan_darah_bulan_terakhir" class="block text-sm text-gray-700">Hasil</label>
                                    <input type="text" name="hasil_pemeriksaan_tekanan_darah_bulan_terakhir" id="hasil_pemeriksaan_tekanan_darah_bulan_terakhir" value="{{ old('hasil_pemeriksaan_tekanan_darah_bulan_terakhir', $kunjungan->hasil_pemeriksaan_tekanan_darah_bulan_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: 120/80 mmHg">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1">
                            <label class="inline-flex items-center">
                                <input type="radio" name="ada_obat_hipertensi" value="Ada" class="form-radio" {{ old('ada_obat_hipertensi', $kunjungan->ada_obat_hipertensi) == 'Ada' ? 'checked' : '' }}>
                                <span class="ml-2">Ada</span>
                            </label>
                            <label class="inline-flex items-center ml-4">
                                <input type="radio" name="ada_obat_hipertensi" value="Tidak" class="form-radio" {{ old('ada_obat_hipertensi', $kunjungan->ada_obat_hipertensi) == 'Tidak' ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1">
                            <label class="inline-flex items-center">
                                <input type="radio" name="sudah_minum_obat_hipertensi" value="Ya" class="form-radio" {{ old('sudah_minum_obat_hipertensi', $kunjungan->sudah_minum_obat_hipertensi) == 'Ya' ? 'checked' : '' }}>
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center ml-4">
                                <input type="radio" name="sudah_minum_obat_hipertensi" value="Tidak" class="form-radio" {{ old('sudah_minum_obat_hipertensi', $kunjungan->sudah_minum_obat_hipertensi) == 'Tidak' ? 'checked' : '' }}>
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2 mt-2">
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <input type="date" name="pemeriksaan_gula_darah_tahun_terakhir" id="pemeriksaan_gula_darah_tahun_terakhir" value="{{ old('pemeriksaan_gula_darah_tahun_terakhir', $kunjungan->pemeriksaan_gula_darah_tahun_terakhir) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                </div>
                        ...
                        <div class="space-y-2 mt-2">
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <input type="date" name="pemeriksaan_gula_darah_bulan_terakhir" id="pemeriksaan_gula_darah_bulan_terakhir" value="{{ old('pemeriksaan_gula_darah_bulan_terakhir', $kunjungan->pemeriksaan_gula_darah_bulan_terakhir ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1">
                            <label class="inline-flex items-center">
                                <input type="radio" name="ada_obat_dm" value="Ada" {{ old('ada_obat_dm', $kunjungan->ada_obat_dm ?? '') == 'Ada' ? 'checked' : '' }} class="form-radio">
                                <span class="ml-2">Ada</span>
                            </label>
                            <label class="inline-flex items-center ml-4">
                                <input type="radio" name="ada_obat_dm" value="Tidak" {{ old('ada_obat_dm', $kunjungan->ada_obat_dm ?? '') == 'Tidak' ? 'checked' : '' }} class="form-radio">
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1">
                            <label class="inline-flex items-center">
                                <input type="radio" name="sudah_minum_obat_dm" value="Ya" {{ old('sudah_minum_obat_dm', $kunjungan->sudah_minum_obat_dm ?? '') == 'Ya' ? 'checked' : '' }} class="form-radio">
                                <span class="ml-2">Ya</span>
                            </label>
                            <label class="inline-flex items-center ml-4">
                                <input type="radio" name="sudah_minum_obat_dm" value="Tidak" {{ old('sudah_minum_obat_dm', $kunjungan->sudah_minum_obat_dm ?? '') == 'Tidak' ? 'checked' : '' }} class="form-radio">
                                <span class="ml-2">Tidak</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                            ...
                            <div class="space-y-2 mt-2">
                                <div class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="date" name="aks_tanggal" id="aks_tanggal" value="{{ old('aks_tanggal', $kunjungan->aks_tanggal ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                    </div>

                                    <!-- Tempat AKS -->
                                    <div class="flex-1">
                                        <label for="aks_tempat" class="block text-sm text-gray-700">Tempat</label>
                                        <input type="text" name="aks_tempat" id="aks_tempat" value="{{ old('aks_tempat', $kunjungan->aks_tempat ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Puskesmas X">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-2 mt-2">
                                <div class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="date" name="skilas_tanggal" id="skilas_tanggal" value="{{ old('skilas_tanggal', $kunjungan->skilas_tanggal ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                    </div>

                                    <!-- Tempat SKILAS -->
                                    <div class="flex-1">
                                        <label for="skilas_tempat" class="block text-sm text-gray-700">Tempat</label>
                                        <input type="text" name="skilas_tempat" id="skilas_tempat" value="{{ old('skilas_tempat', $kunjungan->skilas_tempat ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Puskesmas X">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="perilaku_merokok" value="Aktif" {{ old('perilaku_merokok', $kunjungan->perilaku_merokok ?? '') == 'Aktif' ? 'checked' : '' }} class="form-radio">
                                    <span class="ml-2">Aktif</span>
                                </label>
                                <label class="inline-flex items-center ml-4">
                                    <input type="radio" name="perilaku_merokok" value="Pasif" {{ old('perilaku_merokok', $kunjungan->perilaku_merokok ?? '') == 'Pasif' ? 'checked' : '' }} class="form-radio">
                            ...
                            <div class="space-y-2 mt-2">
                                <div class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="date" name="skrining_kesehatan_jiwa_tanggal" id="skrining_kesehatan_jiwa_tanggal" value="{{ old('skrining_kesehatan_jiwa_tanggal', $kunjungan->skrining_kesehatan_jiwa_tanggal ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                                    </div>

                                    <!-- Tempat Skrining -->
                                    <div class="flex-1">
                                        <label for="skrining_kesehatan_jiwa_tempat" class="block text-sm text-gray-700">Tempat</label>
                                        <input type="text" name="skrining_kesehatan_jiwa_tempat" id="skrining_kesehatan_jiwa_tempat" value="{{ old('skrining_kesehatan_jiwa_tempat', $kunjungan->skrining_kesehatan_jiwa_tempat ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Rumah Sakit X">
                                    </div>

                                    <!-- Petugas Skrining -->
                                    <div class="flex-1">
                                        <label for="skrining_kesehatan_jiwa_petugas" class="block text-sm text-gray-700">Petugas</label>
                                        <input type="text" name="skrining_kesehatan_jiwa_petugas" id="skrining_kesehatan_jiwa_petugas" value="{{ old('skrining_kesehatan_jiwa_petugas', $kunjungan->skrining_kesehatan_jiwa_petugas ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" placeholder="Contoh: Nama Petugas">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="pemberian_edukasi" id="pemberian_edukasi" value="{{ old('pemberian_edukasi', $kunjungan->pemberian_edukasi ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                        </div>

                        <!-- Paraf Lansia -->
                        <div class="mb-4">
                            <label for="paraf_lansia" class="block text-sm font-medium text-gray-700">Paraf Lansia</label>
                            <input type="text" name="paraf_lansia" id="paraf_lansia" value="{{ old('paraf_lansia', $kunjungan->paraf_lansia ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm">
                        </div>
                    </div>
